...
(function () {
  ...
  `;
    ...
    console.info("%c㊗️ FUKIGEN MEDIA ㊗️", styleTitle);
    console.info("%cCopyright © 2024 Fukigen Media", styleSubtitle);
    console.info("%cVisit: https://github.com/fukigenmedia", styleSubtitle);
})();
